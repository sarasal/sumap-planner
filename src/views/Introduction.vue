...
export default {
  ...
  data() {
    return {
      greeting: String(import.meta.env.VITE_GREETING_TEXT),
      current_session: String(import.meta.env.VITE_CURRENT_SESSION_NUMBER_TEXT),
    }
  },
  methods: {
    gotoConsentForm: async function (){
      let url = '/consent-form';
